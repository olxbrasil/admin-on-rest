...
var List = exports.List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.hideFilter = function (filterName) {
            ...
            var newFilters = Object.keys(_this.props.filterValues).reduce(function (filters, key) {
                return key === filterName ? filters : (0, _extends5.default)({}, filters, (0, _defineProperty3.default)({}, key, _this.props.filterValues[key]));
            }, {});
